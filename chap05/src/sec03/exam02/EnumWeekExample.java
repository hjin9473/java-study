...
public class EnumWeekExample {
	public static void main(String[] args) {
		...
		Calendar cal = Calendar.getInstance(); // Calender 객체 얻기
		int week = cal.get(Calendar.DAY_OF_WEEK); // 오늘의 요일 얻기
		...
		//정리:열거 타입의 이점
		// 1. 특정 범위의 값만 사용 가능하므로 타입 안정성 보장(잘못된 값이 들어가면 바로 컴파이 에러 발생)
